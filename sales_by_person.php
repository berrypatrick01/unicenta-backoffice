      ...
      <main class="mdl-layout__content">
        <div class="mdl-layout__tab-panel is-active" id="overview">
          <section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp">
            ...
            <div class="mdl-card mdl-cell mdl-cell--9-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
              <div class="mdl-card__supporting-text">
                 <h4>Sales By Employee:</h4>
                  <form method="POST" action="sales_by_person_view.php">   
                  <label for="ProdName">Employee Name:</label>
            <select class="mdl-textfield__input" id="employee_name" name="employee_name">
            ...
            <input type='text' class="mdl-textfield__input" id = 'fromdate' value='<?php $date = date('Y-m-d 00:00:00'); echo $date;  ?>' name='fromdate' size='17' />
            <label for="fromdate">End Date:</label>
            <input type='text' class="mdl-textfield__input" id = 'enddate' value='<?php $date = date('Y-m-d 00:00:00'); echo $date;  ?>' name='enddate' size='17' />
